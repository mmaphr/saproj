package com.example.sa.g22.demo.Controller;
...
public class ShippingController {
    ...
    @PostMapping("/newShipping/{province_id}/{shippingstatus_id}/{shippingdate}")
    public Shipping newShipping(@PathVariable long province_id,
